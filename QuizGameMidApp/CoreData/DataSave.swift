...
class DataSaver {
    ...
    func dataSave() {
        ...
        let question1 = QuestionsModel(answer: "A. England", isAnswered: false, points: 5, question: "Which country is the largest country in the world?",  category: category.category)
        ...
        let question2 = QuestionsModel(answer: "B. China", isAnswered: false, points: 5, question: "Which country has the highest population?", category: category.category)
        ...
        let question3 = QuestionsModel(answer: "B. Asia", isAnswered: false, points: 5, question: "Which continent is the largest by land area?", category: category.category)
        ...
        let question4 = QuestionsModel(answer: "B. Nile", isAnswered: false, points: 5, question: "What is the longest river in the world?", category: category.category)
        ...
        let question5 = QuestionsModel(answer: "C. Pacific", isAnswered: false, points: 5, question: "Which ocean is the largest?", category: category.category)
        ...
        let question6 = QuestionsModel(answer: "C. Mount Everest", isAnswered: false, points: 10, question: "What is the highest mountain in the world?", category: category.category)
        ...
        let question7 = QuestionsModel(answer: "A. Mercury", isAnswered: false, points: 10, question: "Which planet is closest to the Sun?", category: category.category)
        ...
        let question8 = QuestionsModel(answer: "B. Hydrogen", isAnswered: false, points: 10, question: "What is the most abundant element in the universe?", category: category.category)
        ...
        let question9 = QuestionsModel(answer: "B. Jupiter", isAnswered: false, points: 10, question: "Which planet is the largest in our solar system?", category: category.category)
        ...
        let question10 = QuestionsModel(answer: "A. Cheetah", isAnswered: false, points: 10, question: "What is the fastest land animal?", category: category.category)
        ...
        let question11 = QuestionsModel(answer: "B. Antarctica", isAnswered: false, points: 10, question: "Which continent is the coldest?", category: category.category)
        ...
        let question12 = QuestionsModel(answer: "A. Leonardo da Vinci", isAnswered: false, points: 10, question: "Who painted the Mona Lisa?", category: category.category)
        ...
        let question13 = QuestionsModel(answer: "C. Paris", isAnswered: false, points: 10, question: "What is the capital of France?", category: category.category)
        ...
        let question14 = QuestionsModel(answer: "B. 7", isAnswered: false, points: 10, question: "How many continents are there in the world?", category: category.category)
        ...
        let question15 = QuestionsModel(answer: "A. Australia", isAnswered: false, points: 10, question: "Which country is known as the Land Down Under?", category: category.category)
        ...
        let question16 = QuestionsModel(answer: "B. Water", isAnswered: false, points: 15, question: "What is H2O commonly known as?", category: category.category)
        ...
        let question17 = QuestionsModel(answer: "A. Africa", isAnswered: false, points: 15, question: "Which continent is known as the birthplace of humanity?", category: category.category)
        ...
        let question18 = QuestionsModel(answer: "A. Australia", isAnswered: false, points: 15, question: "In which country does bird kiwi lives", category: category.category)
        ...
        let question19 = QuestionsModel(answer: "A. 196", isAnswered: false, points: 15, question: "How many countries in the world", category: category.category)
        ...
        let question20 = QuestionsModel(answer: "B. Pacific", isAnswered: false, points: 15, question: "Which ocean is the deepest?", category: category.category)
